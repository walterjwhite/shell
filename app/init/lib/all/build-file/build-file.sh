_app_build_package_file() {
  ...
  if [ -f "$_buildfile_per_file_cfg" ]; then
    ...
    _buildfile_per_file_vars_to_unset=$(comm -13 "$_pre_vars_tmp" "$_post_vars_tmp")
